...
September also saw the start of work on a new database system for Merury 2 &ndash; replacing the previously fractured 2-database solution with a unified database on  [SurrealDB](https://surrealdb.com).
