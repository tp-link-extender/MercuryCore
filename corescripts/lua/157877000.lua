...
function initializeDeveloperConsole()
	...
	Dev_Container.Body.ResizeButton.MouseButton1Up:connect(function(_, _)
		clean()
	end)

	---Handle Dev-Console Close Button
	Dev_TitleBar.CloseButton.MouseButton1Down:connect(function(_, _)
	...
	Dev_OptionsButton.MouseButton1Down:connect(function(_, _)
