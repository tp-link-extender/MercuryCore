...
void main ()
{
  ...
  normal_5.xy = (tmpvar_8 + (((texture2D (NormalDetailMap, (xlv_TEXCOORD0.xy * 7.0)).wy * 2.0) - 1.0) * 0.6));
  normal_5.xy = (normal_5.xy * tmpvar_3);
  albedo_4 = (((xlv_COLOR0.xyz * diffuse_6.xyz) * (1.0 + (normal_5.x * 0.3))) * (texture2D (StudsMap, xlv_TEXCOORD1.xy).xyz * 2.0));
  vec2 tmpvar_10;
  tmpvar_10 = mix (vec2(0.25, 32.0), ((texture2D (SpecularMap, xlv_TEXCOORD0.xy).xy * vec2(2.0, 256.0)) + vec2(0.0, 0.01)), vec2(tmpvar_3));
  vec4 tmpvar_11;
