...
void main ()
{
  ...
  albedo_4 = (((xlv_COLOR0.xyz * diffuse_6.xyz) * (1.0 + (normal_5.x * 0.1))) * (texture2D (StudsMap, xlv_TEXCOORD1.xy).xyz * 2.0));
  vec2 tmpvar_10;
  tmpvar_10 = mix (vec2(0.26, 26.0), ((texture2D (SpecularMap, xlv_TEXCOORD0.xy).xy * vec2(1.3, 64.0)) + vec2(0.0, 0.01)), vec2(tmpvar_3));
  vec4 tmpvar_11;
