...
void main ()
{
  ...
  tmpvar_11 = ((mix (vec3(1.0, 1.0, 1.0), xlv_COLOR0.xyz, vec3(mix (1.0, tmpvar_6.w, tmpvar_3))) * diffuse_5.xyz) * (1.0 + (normal_4.x * 0.5)));
  highp vec4 tmpvar_12;
  lowp vec4 tmpvar_13;
  tmpvar_13 = texture2D (SpecularMap, xlv_TEXCOORD0.xy);
  tmpvar_12 = tmpvar_13;
  highp vec2 tmpvar_14;
  tmpvar_14 = mix (vec2(0.35, 103.0), ((tmpvar_12.xy * vec2(1.0, 256.0)) + vec2(0.0, 0.01)), vec2(tmpvar_3));
