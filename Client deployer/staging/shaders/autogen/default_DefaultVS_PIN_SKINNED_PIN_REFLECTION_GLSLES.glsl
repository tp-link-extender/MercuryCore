...
void main ()
{
  ...
  tmpvar_14.xyz = (CameraPosition - tmpvar_7);
  tmpvar_14.w = (tmpvar_12.w * FadeDistance.y);
  highp vec4 tmpvar_15;
  tmpvar_15 = ((uv4 * FadeDistance.z) + (0.5 * tmpvar_14.w));
  tmpvar_1.zw = tmpvar_15.xy;
  tmpvar_2.zw = tmpvar_15.zw;
  highp vec4 tmpvar_16;
  tmpvar_16.xyz = tmpvar_8;
  tmpvar_16.w = secondary_colour.z;
  highp vec4 tmpvar_17;
  tmpvar_17.xyz = ((tmpvar_10.y * Lamp0Color) + (max (-(tmpvar_9), 0.0) * Lamp1Color));
  tmpvar_17.w = (tmpvar_10.z * (secondary_colour.y / 255.0));
