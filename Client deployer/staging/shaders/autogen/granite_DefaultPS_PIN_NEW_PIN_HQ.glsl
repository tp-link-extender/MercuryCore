...
void main ()
{
  ...
  vec4 diffuse_5;
  vec4 tmpvar_6;
  tmpvar_6 = mix (texture2D (DiffuseMap, (xlv_TEXCOORD0.xy * 0.25)), texture2D (DiffuseMap, xlv_TEXCOORD0.xy), vec4(clamp (((tmpvar_3 * 4.0) - 3.0), 0.0, 1.0)));
  ...
  vec2 tmpvar_8;
  tmpvar_8 = mix (vec2(0.19, 24.0), ((tmpvar_7.xy * vec2(0.5, 128.0)) + vec2(0.0, 0.01)), vec2(tmpvar_3));
  vec4 tmpvar_9;
