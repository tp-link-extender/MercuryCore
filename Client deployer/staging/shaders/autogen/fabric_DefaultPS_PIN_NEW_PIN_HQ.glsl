...
void main ()
{
  ...
  albedo_4 = (((xlv_COLOR0.xyz * diffuse_6.xyz) * (1.0 + (normal_5.x * 0.2))) * (texture2D (StudsMap, xlv_TEXCOORD1.xy).xyz * 2.0));
  vec2 tmpvar_10;
  tmpvar_10 = mix (vec2(0.03, 16.0), ((texture2D (SpecularMap, xlv_TEXCOORD0.xy).xy * vec2(0.2, 128.0)) + vec2(0.0, 0.01)), vec2(tmpvar_3));
  vec4 tmpvar_11;
